...
$FileSystemWatcher.Path= "\\TVMONBROKER\XMLInbox\ShipmentNotice\XMLOutResponse"  
...
$query = "INSERT INTO plannermailing.summarywatchdogReturnXML(
FileName,
ReturnXMLCreatedTime,
ResponseFlag
)
VALUES ('$name','$timeStamp','$flag')"
